...
<form name ="modificarPersona" action="" method="POST">
        ...
        <p>
            <label for="nombre">Nombre de la empresa a modificar: </label>
        ...
        if(isset($_POST['nombre']) && !empty($_POST['nombre']) && isset($_POST['nombreNuevo']) && !empty($_POST['nombreNuevo']) && isset($_POST['emailNuevo']) && !empty($_POST['emailNuevo']) 
